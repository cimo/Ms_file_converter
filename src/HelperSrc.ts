...
export const URL_TEST = Ce.checkVariable("MS_FC_URL_TEST") || (process.env.MS_FC_URL_TEST as string);
...
export const PATH_FILE_DOWNLOAD = Ce.checkVariable("MS_FC_PATH_FILE_DOWNLOAD");
...
export const WS_ADRESS = Ce.checkVariable("MS_FC_WS_ADDRESS") || (process.env.MS_FC_WS_ADDRESS as string);
export const SECRET_KEY = Ce.checkVariable("MS_FC_SECRET_KEY");
