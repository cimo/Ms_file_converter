...
export const IS_DEBUG = Ce.checkVariable("MS_FC_IS_DEBUG") || (process.env["MS_FC_IS_DEBUG"] as string);
...
export const PATH_CERTIFICATE_PEM = Ce.checkVariable("MS_FC_PATH_CERTIFICATE_PEM");
...
export const PERSISTENCE_SECOND = Ce.checkVariable("MS_FC_PERSISTENCE_SECOND") || (process.env["MS_FC_PERSISTENCE_SECOND"] as string);
